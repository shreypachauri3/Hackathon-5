...
class Styles{
  ...
  static Gradient bgColor1= LinearGradient(colors: [
    Colors.white,
  ...
  static TextStyle headLineStyle3 = TextStyle(fontSize:17,color:Colors.grey.shade600,fontWeight: FontWeight.w300);
  static TextStyle headLineStyle3_1 = const TextStyle(fontSize:17,color:Colors.black,fontWeight: FontWeight.bold);
